          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  <?php
                    $sql = "select count(id)'motherboards' from motherboard";
                    $result = mysqli_query($con, $sql);
                    if (mysqli_num_rows($result) > 0) 
                      $row = mysqli_fetch_assoc($result);
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  <?php
                    $sql = "select count(id)'laptops' from laptop";
                    $result = mysqli_query($con, $sql);
                    if (mysqli_num_rows($result) > 0) 
                      $row = mysqli_fetch_assoc($result);
                    echo $row['laptops'];
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="position-relative mb-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                  <canvas id="visitors-chart" height="400" width="742" class="chartjs-render-monitor" style="display: block; height: 200px; width: 371px;"></canvas>
                </div>
